...
BOOK_DOCS = [
    ...
    dict(
        md_file="6一無王開叫/一無王開叫.md",
        slug="一無王開叫",
        title="第六章 一無將開叫及其發展",
        image_dir="一無王開叫",
        lede="1NT 開叫後的第一應叫、2♦ 接力主幹（A–C 分支）與對 1NT 開叫的防守叫牌，含原始截圖對照還原。",
    ),
    dict(
    ...
    dict(
        md_file="8二梅花開叫/二梅花開叫.md",
        slug="二梅花開叫",
        title="第八章 二梅花開叫及其發展",
        image_dir="二梅花開叫",
        lede="2♣ 開叫（至少5張♣、11-15點）後的 A–D 四個分支接力與三副示例牌，含原始截圖對照還原。",
    ),
    dict(
        md_file="11最後的改動/最後的改動.md",
        slug="最後的改動",
        title="第十一章 最後的改動",
        image_dir="最後的改動",
        lede="1♣–1♥–1♠ 改為接力、選擇性 2♦ 開叫，以及連帶改寫第四章、第七章既有設計的四處修訂，含原始截圖對照還原。",
    ),
]
...
def build_index():
    body = page_head(
        ...
        "接力叫序資料庫",
        ["6 份叫序資料表", "7 篇原始書籍章節"],
        "整理自《北歐接力精確體系》一書，收錄一方塊、一梅花、二梅花、高花、一無王、二方塊六種開叫的完整接力叫序資料，"
...
<section>
  ...
  <div class="card-grid">
    ...
    <a class="doc-card" href="叫序資料/二方塊開叫.html">
      <div class="k">Diamonds II</div>
      <h3>二方塊開叫</h3>
      <p>選擇性 2♦ 開叫的答叫、2NT 後接力與 1♦ 開叫的連鎖修訂，共 4 個工作表。</p>
    </a>
  </div>
</section>
...
<section>
  ...
  <div class="card-grid">
    ...
    <a class="doc-card" href="原始書籍檔案/一無王開叫.html">
    ...
    <a class="doc-card" href="原始書籍檔案/二梅花開叫.html">
      ...
      <h3>二梅花開叫及其發展</h3>
      <p>2♣ 開叫後的接力系統與 A–D 分支發展。</p>
    </a>
    <a class="doc-card" href="原始書籍檔案/最後的改動.html">
      <div class="k">Chapter 11</div>
      <h3>最後的改動</h3>
      <p>1♣–1♥–1♠ 改為接力、選擇性 2♦ 開叫，以及改寫第四、七章的四處修訂。</p>
    </a>
  </div>
</section>
...
def main():
    ...
    build_xlsx_page("二方塊開叫.xlsx", "二方塊開叫", "叫序資料 · 二方塊開叫",
                     "選擇性 2♦ 開叫（4-8點、5張高花+4張低花）的答叫、2NT 後接力與 1♦ 開叫的連鎖修訂。")
    build_book_pages()
